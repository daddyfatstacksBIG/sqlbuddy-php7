...
if ($_POST) {
    ...
    if (isset($db)) {
        ...
        if (isset($table)) {
            $tables[] = $table;
        } elseif (isset($_POST['EXPORTTABLE'])) {
                    ...
                    if (isset($exportStructure)) {
                        if ($conn->isResultSet($structureSQL)) {
                            ...
                            while ($structureRow = $conn->fetchassoc($structureSQL)) {
                                ...
                                } elseif (isset($structureRow['Default']) && $structureRow['Default'] != "") {
...
<div class="export">
    ...
    $showSeperator = true;
    } elseif (isset($db) && isset($table)) {
        ?>
	<tr>
		<td class="secondaryheader"><?php echo __("Format"); ?>:</td>
		<td>
			<label><input type="radio" name="FORMAT" id="SQLTOGGLE" value="SQL" onchange="updatePane('SQLTOGGLE', 'sqlpane', 'csvpane')" onclick="updatePane('SQLTOGGLE', 'sqlpane', 'csvpane')" <?php if ((isset($format) && $format == "SQL")|| !isset($format)) {
            echo 'checked="checked"';
        } ?> /><?php echo __("SQL"); ?></label><br />
			<label><input type="radio" name="FORMAT" value="CSV" onchange="updatePane('SQLTOGGLE', 'sqlpane', 'csvpane')" onclick="updatePane('SQLTOGGLE', 'sqlpane', 'csvpane')" <?php if (isset($format) && $format == "CSV") {
            echo 'checked="checked"';
        } ?> /><?php echo __("CSV"); ?></label>
		</td>
	</tr>
	<?php
	...
	<table cellpadding="0" id="sqlpane"<?php if (isset($format) && $format == "CSV") {
        echo ' style="display: none"';
    } ?>>
	<tr>
		<td class="secondaryheader"><?php echo __("Export"); ?>:</td>
		<td>
			<label><input type="checkbox" name="STRUCTURE" value="STRUCTURE" <?php if (isset($exportStructure) || !($_POST)) {
        echo 'checked="checked"';
    } ?> /><?php echo __("Structure"); ?></label><br />
			<label><input type="checkbox" name="DATA" value="DATA" <?php if (isset($exportData) || !($_POST)) {
        echo 'checked="checked"';
	...
	<tr>
		...
		<td>
			<label><input type="radio" name="INSERTTYPE" value="COMPACT" <?php if ((isset($insertType) && $insertType == "COMPACT") || !isset($insertType)) {
        echo 'checked="checked"';
    } ?> /><?php echo __("Compact inserts"); ?></label><br />
			<label><input type="radio" name="INSERTTYPE" value="COMPLETE" <?php if (isset($insertType) && $insertType == "COMPLETE") {
        echo 'checked="checked"';
    } ?> /><?php echo __("Complete inserts"); ?></label>
		</td>
	</tr>
	</table>

	<table cellpadding="0" id="csvpane"<?php if ((isset($format) && $format == "SQL") || !isset($format)) {
        echo ' style="display: none"';
    } ?>>
	<tr>
		<td class="secondaryheader"><?php echo __("Delimiter"); ?>:</td>
		<td>
			<label><input type="radio" name="DELIMITER" value="COMMA"<?php if (isset($delimiter) && $delimiter == "," || !isset($delimiter)) {
        echo ' checked="checked"';
    } ?> /><?php echo __("Comma"); ?></label><br />
			<label><input type="radio" name="DELIMITER" value="TAB"<?php if (isset($delimiter) && $delimiter == "\t") {
        echo ' checked="checked"';
    } ?> /><?php echo __("Tab"); ?></label><br />
			<label><input type="radio" name="DELIMITER" value="SEMICOLON"<?php if (isset($delimiter) && $delimiter == ";") {
        echo ' checked="checked"';
    } ?> /><?php echo __("Semicolon"); ?></label><br />
			<label><input type="radio" name="DELIMITER" value="SPACE"<?php if (isset($delimiter) && $delimiter == " ") {
        echo ' checked="checked"';
    } ?> /><?php echo __("Space"); ?></label>
		</td>
	</tr>
	<tr>
		<td class="secondaryheader"><?php echo __("Options"); ?>:</td>
		<td>
			<label><input type="checkbox" name="FIELDNAMES" value="TRUE"<?php if (isset($printFieldnames)) {
        echo ' checked="checked"';
    } ?> /><?php echo __("Print field names on first line"); ?></label><br />
		</td>
	</tr>
	</table>
	...
	<tr>
		...
		<td>
			<label><input type="radio" name="OUTPUT" value="BROWSER"<?php if (isset($output) && $output == "BROWSER" || !isset($output)) {
        echo ' checked="checked"';
    } ?> /><?php echo __("Browser"); ?></label><br />
			<label><input type="radio" name="OUTPUT" id="OUTPUTFILE" value="FILE" onchange="exportFilePrep()"<?php if (isset($output) && $output == "FILE") {
        echo ' checked="checked"';
    } ?> /><?php echo __("Text file"); ?>:</label><input type="text" class="text" name="OUTPUTFILETEXT" id="OUTPUTFILETEXT" value="<?php if (isset($outputFile)) {
        echo basename($outputFile);
    } elseif (isset($format) && $format == "CSV") {
        echo strtolower(__("Export")) . ".csv";
    } else {
        echo strtolower(__("Export")) . ".sql";
